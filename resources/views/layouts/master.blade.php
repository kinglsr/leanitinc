<meta charset="utf-8" />
<title>LeanITInc Consultancy</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1" name="viewport" />
<meta content="LeanITInc CONSULTANCY" name="description" />
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">LeanITInc</a>
    </div>
...
$(function(){
    ...
    $("#staff").click(function() {
        $('html, body').animate({
            scrollTop: $("#staff-section").offset().top - 80
        }, 1200);
    });
